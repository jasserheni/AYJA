        ...
        {cart.cartItems.length > 0 &&
          <Footer>
            ...
            <div className='buttons'>
              ...
              <div>
                {!isAuthenticated
                  ? <Link to='/my-account/login' onClick={() => toggleSideCart()}><button className='checkout-btn'>Log in to checkout</button></Link>
                  : <Link to='/cart' onClick={() => toggleSideCart()}><button className='checkout-btn'>checkout</button></Link>
                }
              </div>
